...
class SettingsService {
  ...
  async getSettingsByCategory(category) {
    switch (category.toLowerCase()) {
      ...
      default:
        throw new Error(
          "Invalid category. Must be: company, banking, or system",
        );
    }
  }
  ...
  async updateCompanyInfo(data) {
    ...
    if (data.primary_phone !== undefined)
      updateData.primaryPhone = data.primary_phone;
    if (data.alternative_phone !== undefined)
      updateData.alternativePhone = data.alternative_phone;
    if (data.email !== undefined) updateData.email = data.email;
    if (data.website !== undefined) updateData.website = data.website;
    if (data.address !== undefined) updateData.address = data.address;
    if (data.founded_year !== undefined)
      updateData.foundedYear = data.founded_year;
  ...
  async updateBankingDetails(data) {
    ...
    if (data.account_holder !== undefined)
      updateData.accountHolder = data.account_holder;
    if (data.sort_code !== undefined) updateData.sortCode = data.sort_code;
    if (data.account_number !== undefined)
      updateData.accountNumber = data.account_number;
    if (data.payment_terms !== undefined)
      updateData.paymentTerms = data.payment_terms;
  ...
  async updateSystemConfig(data) {
    ...
    if (data.invoice_generation_day !== undefined)
      updateData.invoiceGenerationDay = data.invoice_generation_day;
    if (data.invoice_generation_time !== undefined)
      updateData.invoiceGenerationTime = data.invoice_generation_time;
    if (data.session_timeout !== undefined)
      updateData.sessionTimeout = parseInt(data.session_timeout);
    if (data.auto_invoicing !== undefined)
      updateData.autoInvoicing =
        data.auto_invoicing === "true" || data.auto_invoicing === true;
    ...
    if (data.sms_notifications !== undefined)
      updateData.smsNotifications =
        data.sms_notifications === "true" || data.sms_notifications === true;
    if (data.maps_api_enabled !== undefined)
      updateData.mapsApiEnabled =
        data.maps_api_enabled === "true" || data.maps_api_enabled === true;
